...
#define     CONF_GM_MM_PULSE         20   	// 拉料电机 细分800，导程10MM，同步轮2：1
#define     CONF_LM_MM_PULSE         21     // 放料电机32		1:20
#define     CONF_BM_MM_PULSE         21     // 上收料电机11		1:5
#define     CONF_SM_MM_PULSE         21     // 下收料电机32		1:20
...
#define     CONF_GM_OFFSET      5000    ///< 送料偏移 -- 0X5001 贴标位置1
...
#define     CONF_SM_SPEED       5000    ///< 收料速度	-- 0X5006 收料速度
#define     CONF_SM_DISTANCE    5000    ///< 收料行程	-- 0X5007 收料行程

#define     CONF_GOZERO_SPEED   3000     ///< 回原点速度	-- 0X5008 初始化速度
#define     CONF_ZERO_OFFSET    0       ///< 原点偏移		-- 0X5009 回原点偏移

#define     CONF_GM_AMP         10     ///< 送料电机电流-- 0X500A 贴标电机齿轮比
#define     CONF_GM_MS          3       ///< 送料电机细分-- 0X500B 贴标电机细分
#define     CONF_LM_AMP         150      ///< 放料电机电流
#define     CONF_LM_MS          2       ///< 放料电机细分
#define     CONF_BM_AMP         150      ///< 剥料电机电流
#define     CONF_BM_MS          2       ///< 剥料电机细分
#define     CONF_SM_AMP         150      ///< 收料电机电流-- 0X5010
#define     CONF_SM_MS          3       ///< 收料电机细分-- 0X5011

#define		CONF_HC_D2			8000		///< 贴标位置2-- 0x5012
#define		CONF_BS_POINT		1000		///< 取标行程-- 0x5013
#define		CONF_HL_DISTANCE	0		///<保压时间-- 0x5014
...
#define     CONF_DEVICE_NAME                "在线打印贴标供料器"
#define     CONF_DEVICE_NAME_LEN            28
#define     EN_CONF_DEVICE_NAME             "Online Printing Label Feeder"
#define     EN_CONF_DEVICE_NAME_LEN         28
#define     CONF_DEVICE_NO                  "ARD-PRT-001-A3"
#define     CONF_DEVICE_NO_LEN              14
#define     CONF_HARDWARE_VER               "ARD-22M-12I8O-AE"
#define     CONF_HARDWARE_VER_LEN           16
#define     CONF_SOFTWARE_VER               "V1.0.0 20260123"
...
// 输入信号页输入信号名称
#define     CONF_INPUT_00_NAME              "备用"//"贴标到位信号"
#define     CONF_INPUT_00_NAME_LEN          14

#define     EN_CONF_INPUT_00_NAME           "Spare"//"Label Successfully"
#define     EN_CONF_INPUT_00_NAME_LEN      	14

#define     CONF_INPUT_01_NAME              "气缸缩回到位"
#define     CONF_INPUT_01_NAME_LEN          18

#define     EN_CONF_INPUT_01_NAME           "Cylinder Retracted"
#define     EN_CONF_INPUT_01_NAME_LEN        18

#define     CONF_INPUT_02_NAME              "气缸伸出到位"
#define     CONF_INPUT_02_NAME_LEN          18

#define     EN_CONF_INPUT_02_NAME           "Cylinder Extended"
#define     EN_CONF_INPUT_02_NAME_LEN       16

#define     CONF_INPUT_03_NAME              "真空检测"
#define     CONF_INPUT_03_NAME_LEN          14

#define     EN_CONF_INPUT_03_NAME          "Vacuum Check"
#define     EN_CONF_INPUT_03_NAME_LEN       14

#define     CONF_INPUT_04_NAME              "光纤检测信号"
#define     CONF_INPUT_04_NAME_LEN          18

#define    	EN_CONF_INPUT_04_NAME         	"Fiber Check Signal"
#define     EN_CONF_INPUT_04_NAME_LEN      	18

#define     CONF_INPUT_05_NAME              "收料到位信号"
#define     CONF_INPUT_05_NAME_LEN          18

#define     EN_CONF_INPUT_05_NAME           "Rewinder Sensor"
#define     EN_CONF_INPUT_05_NAME_LEN       18

#define     CONF_INPUT_06_NAME              "备用"
#define     CONF_INPUT_06_NAME_LEN          24

#define     EN_CONF_INPUT_06_NAME           "Spare"
#define     EN_CONF_INPUT_06_NAME_LEN       24

#define     CONF_INPUT_07_NAME              "备用"
#define     CONF_INPUT_07_NAME_LEN          24

#define     EN_CONF_INPUT_07_NAME           "Spare"
#define     EN_CONF_INPUT_07_NAME_LEN       24

#define     CONF_INPUT_08_NAME              "备用"
#define     CONF_INPUT_08_NAME_LEN          20

#define     EN_CONF_INPUT_08_NAME           "Spare"
#define     EN_CONF_INPUT_08_NAME_LEN       20

#define     CONF_INPUT_09_NAME              "备用"
#define     CONF_INPUT_09_NAME_LEN          20

#define     EN_CONF_INPUT_09_NAME           "Spare"
#define     EN_CONF_INPUT_09_NAME_LEN       20

#define     CONF_INPUT_10_NAME              "备用"
#define     CONF_INPUT_10_NAME_LEN          22

#define     EN_CONF_INPUT_10_NAME           "备用"
#define     EN_CONF_INPUT_10_NAME_LEN       22
...
#define 	CONF_EXI4_NAME_LEN				22

#define     EN_CONF_EXI4_NAME              "Spare"
#define     EN_CONF_EXI4_NAME_LEN          22

#define 	CONF_EXI5_NAME					"备用"
#define 	CONF_EXI5_NAME_LEN				22

#define     EN_CONF_EXI5_NAME              "Spare"
#define     EN_CONF_EXI5_NAME_LEN          22

#define 	CONF_EXI04_NAME					"备用"
#define 	CONF_EXI04_NAME_LEN				22

#define 	EN_CONF_EXI04_NAME					"Spare"
#define 	EN_CONF_EXI04_NAME_LEN				22

#define 	CONF_EXI05_NAME					"备用"
#define 	CONF_EXI05_NAME_LEN				22

#define 	EN_CONF_EXI05_NAME					"Spare"
#define 	EN_CONF_EXI05_NAME_LEN				22

#define 	CONF_EXI6_NAME					"备用"
#define 	CONF_EXI6_NAME_LEN				22

#define 	EN_CONF_EXI6_NAME				"Spare"
#define 	EN_CONF_EXI6_NAME_LEN			22

#define 	CONF_EXI7_NAME					"备用"
#define 	CONF_EXI7_NAME_LEN				8

#define 	EN_CONF_EXI7_NAME				"Spare"
#define 	EN_CONF_EXI7_NAME_LEN			8

// 供料器对外输入信号名称
#define 	CONF_EXI0_NAME					"打印状态信号"
#define 	CONF_EXI0_NAME_LEN				12

#define 	EN_CONF_EXI0_NAME					"Print status"
#define 	EN_CONF_EXI0_NAME_LEN				12

#define 	CONF_EXI1_NAME					"送标信号"
...
// 供料器内部控制信号名称显示
#define     CONF_INNER_CTRL_NAME_1          "真空"
#define     CONF_INNER_CTRL_NAME_1_LEN      14

#define     EN_CONF_INNER_CTRL_NAME_1       "Vacuum"
#define     EN_CONF_INNER_CTRL_NAME_1_LEN   14

#define     CONF_INNER_CTRL_NAME_2          "备用"//"吹气"
#define     CONF_INNER_CTRL_NAME_2_LEN      12

#define     EN_CONF_INNER_CTRL_NAME_2       "Spare"//"Blow"
#define     EN_CONF_INNER_CTRL_NAME_2_LEN   12

#define     CONF_INNER_CTRL_NAME_3          "气缸缩回"
#define     CONF_INNER_CTRL_NAME_3_LEN      12

#define     EN_CONF_INNER_CTRL_NAME_3       "Cylinder Retracted"
#define     EN_CONF_INNER_CTRL_NAME_3_LEN   12

#define     CONF_INNER_CTRL_NAME_4          "气缸伸出"
#define     CONF_INNER_CTRL_NAME_4_LEN      13

#define     EN_CONF_INNER_CTRL_NAME_4       "Cylinder Extended"
#define     EN_CONF_INNER_CTRL_NAME_4_LEN    13

#define     CONF_INNER_CTRL_NAME_5          "备用"
#define     CONF_INNER_CTRL_NAME_5_LEN      14

#define     EN_CONF_INNER_CTRL_NAME_5        "Spare"
#define     EN_CONF_INNER_CTRL_NAME_5_LEN     14

#define     CONF_INNER_CTRL_NAME_6          "备用"
#define     CONF_INNER_CTRL_NAME_6_LEN      11

#define     EN_CONF_INNER_CTRL_NAME_6          "Spare"
#define     EN_CONF_INNER_CTRL_NAME_6_LEN      11

#define     CONF_INNER_CTRL_NAME_7          "备用"
#define     CONF_INNER_CTRL_NAME_7_LEN      18

#define     EN_CONF_INNER_CTRL_NAME_7          "Spare"
#define     EN_CONF_INNER_CTRL_NAME_7_LEN      18

#define     CONF_INNER_CTRL_NAME_8          "备用"
#define     CONF_INNER_CTRL_NAME_8_LEN      18

#define     EN_CONF_INNER_CTRL_NAME_8          "Spare"
#define     EN_CONF_INNER_CTRL_NAME_8_LEN      18
...
#define     CONF_OUTER_CTRL_NAME_2          "请求打印信号"
...
#define     CONF_OUTER_CTRL_NAME_3          " 送标完成信号 "
#define     CONF_OUTER_CTRL_NAME_3_LEN      14

#define     EN_CONF_OUTER_CTRL_NAME_3          "Stick complete"
#define     EN_CONF_OUTER_CTRL_NAME_3_LEN      14

#define     CONF_OUTER_CTRL_NAME_4          " 取标完成信号 "
#define     CONF_OUTER_CTRL_NAME_4_LEN      14

#define     EN_CONF_OUTER_CTRL_NAME_4          "Fetch complete"
...
#define OVER_RANGE_5_2000() 		GUI_showMessage("参数越界,设置范围5-2000", 23)
...
#define OVER_RANGE_5_300() 			GUI_showMessage("参数越界,设置范围5-300", 22)
#define EN_OVER_RANGE_5_300() 		GUI_showMessage("Parameter is invalid,setting range:5-300", 40)
...
#else
	#define     CONF_S_LEN                      999
	#define     CONF_S_1000_FACTOR_NO           2       // 选择加速曲线-1000步//经过测试，曲线2效果最佳
	#define 	CONF_S_OFFSET_GIVEN				4		///< 送料电机，查询数值表的偏移、1000/CONF_S_OFFSET=减速步数
	#define 	CONF_S_OFFSET_LET				10		///< 放料电机，查询数值表的偏移、1000/CONF_S_OFFSET=减速步数
	#define 	CONF_S_OFFSET_BO				10		///< 剥料电机，查询数值表的偏移、1000/CONF_S_OFFSET=减速步数
	#define 	CONF_S_OFFSET_SHOU				10		///< 收料电机，查询数值表的偏移、1000/CONF_S_OFFSET=减速步数
#endif
