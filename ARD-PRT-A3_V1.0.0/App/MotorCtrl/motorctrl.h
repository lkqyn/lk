...
#define     UP_MOTOR            CONF_SM_NO          //ͨ��3
#define     DOWN_MOTOR          CONF_BM_NO          //ͨ��2
...
#define     UP_MM_PULSE         CONF_BM_MM_PULSE
#define     DOWN_MM_PULSE       CONF_SM_MM_PULSE

//#define     UP_MOTOR            CONF_GM_NO          ///< �����ϵ��
