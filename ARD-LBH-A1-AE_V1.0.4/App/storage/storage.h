...
#define     STORAGE_GMDISTANCE_ADDR         0x34    ///< 送料补偿
#define     STORAGE_HCD2_ADDR               0x36    ///< 第二次后撤距离
//#define     STORAGE_BSPOINT_ADDR            0x38    ///<
#define     STORAGE_CHANGEOVER_ADDR         0x38    ///< 换料行程
#define     STORAGE_RSTSPEED_ADDR           0x3A    ///< 复位速度
#define     STORAGE_BS1POINT_ADDR         	0x3C   	///< 送料变速位置
#define     STORAGE_LOWGMSPEED_ADDR         0x3E    ///< 变速速度
#define     STORAGE_LOWBODISTANCE_ADDR      0x40    ///< 慢速剥料行程
#define     STORAGE_LOWBO_SPEED_ADDR        0x42   	///< 慢速剥料速度
...
#define 	STORAGE_LANGUAGE_ADDR			0x47	//language


#define 	STORAGE_LET_EN_ADDR				0X70
#define 	STORAGE_UP_EN_ADDR				0X71
#define 	STORAGE_DOWN_EN_ADDR			0x72
#define 	STORAGE_AUTOSONG_EN_ADDR		0x73
#define 	STORAGE_CYLINDERSSOR_EN_ADDR	0x74
#define 	STORAGE_UPSSOR_EN_ADDR			0x75
#define 	STORAGE_RST_AUTOSONG_EN_ADDR	0x76
#define		STORAGE_CLOSEHC_EN_ADDR			0X77
#define		STORAGE_LACKMATERRAL_NC_EN_ADDR 0X78
#define 	STORAGE_UPSENSORREAL_EN_ADDR	0X79
#define		STORAGE_LOWSPEEDSENSOR_EN_ADDR	0X7A
#define		STORAGE_GIVENIENDISNOALARM_EN_ADDR	0X7B //isGivenEndNoAlarmEnable
#define		STORAGE_EM_STOP_EN_ADDR				0X7C //isInEmergencyStopEnable
#define		STORAGE_UPSENSORDOWNWITHOUT_EN_ADDR	0X7D //isUpSensorDownWichoutEnable
#define		STORAGE_INITSWONLINE_EN_ADDR		0X7D
#define 	STORAGE_DOWNSENSORREAL_EN_ADDR		0X7E
#define 	STORAGE_SHOUSTEEPSENSORREAL_EN_ADDR	0X7F

#define 	STORAGE_GIVEN_DIR_ADDR			0x80
#define 	STORAGE_LET_DIR_ADDR			0x81
#define 	STORAGE_BO_DIR_ADDR				0x82
#define 	STORAGE_SHOU_DIR_ADDR			0x83
