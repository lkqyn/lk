...
#define SET_SDA()       HAL_GPIO_WritePin(IIC_SDA_GPIOx, IIC_SDA_PIN, GPIO_PIN_SET)
#define SET_SCL()       HAL_GPIO_WritePin(IIC_SCL_GPIOx, IIC_SCL_PIN, GPIO_PIN_SET)
#define RESET_SDA()     HAL_GPIO_WritePin(IIC_SDA_GPIOx, IIC_SDA_PIN, GPIO_PIN_RESET)
#define RESET_SCL()     HAL_GPIO_WritePin(IIC_SCL_GPIOx, IIC_SCL_PIN, GPIO_PIN_RESET)
#define SDA_DATA        HAL_GPIO_ReadPin(IIC_SDA_GPIOx, IIC_SDA_PIN)
