...
{ 
    ...
    AFIO->EXTICR[1] |= AFIO_EXTICR2_EXTI5_PD | AFIO_EXTICR2_EXTI4_PD;
    AFIO->EXTICR[2] |= AFIO_EXTICR3_EXTI11_PD | AFIO_EXTICR3_EXTI10_PC;
    AFIO->EXTICR[3] |= AFIO_EXTICR4_EXTI12_PD | AFIO_EXTICR4_EXTI13_PD | AFIO_EXTICR4_EXTI14_PD | AFIO_EXTICR4_EXTI15_PA; //
    EXTI->FTSR |= EXTI_FTSR_TR5 | EXTI_FTSR_TR4 | EXTI_FTSR_TR11 | EXTI_FTSR_TR12 | EXTI_FTSR_TR13 | EXTI_FTSR_TR14 | EXTI_FTSR_TR15;
    EXTI->RTSR |= EXTI_FTSR_TR10;//急停上升沿触发
    EXTI->IMR &= ~(EXTI_IMR_MR5 |EXTI_IMR_MR4 | EXTI_IMR_MR10 | EXTI_IMR_MR11 | EXTI_IMR_MR12 | EXTI_IMR_MR13 | EXTI_IMR_MR14 | EXTI_IMR_MR15);
