/* TIM1 两相全桥 PWM 的安全启动、制动和相电压换算实现。 */
#include "motor_pwm.h"
...
/* 一次性把 A/B 相毫伏请求转换为 PWM，避免两相分次更新。 */
