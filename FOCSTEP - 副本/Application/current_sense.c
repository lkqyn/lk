/* A/B 相 ADC 采样、零偏校准及 20 kHz 同步回调实现。 */
...
/* 配置 ADC 注入组为由 TIM4_CC2 同步触发的 A/B 相采样。 */
...
/* ADC 注入转换完成中断：更新电流并调用已登记的实时控制回调。 */
