...
/* 由连续相位索引取得 Q15 正弦、余弦，供 Park/反 Park 共用。 */
...
/* 用整数电角计数把 d/q 电压或电流还原到 alpha/beta。 */
