...
/*
 * 停机或受控条件下的电机诊断模块。
 * 提供相电流、闭环电流和 d/q 动态测试；不属于产品态脉冲运动链路。
 */
#ifdef __cplusplus
extern "C" {
#endif
