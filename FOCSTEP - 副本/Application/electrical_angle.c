...
/* 将 Q16 编码器位置换算为 Park/反 Park 使用的连续相位索引。 */
...
/* 保存对齐时编码器位置和 B 相符号，建立机械到电角的零点映射。 */
...
/* 校验并保存 201 个整步边界中点，用于补偿编码器周期性非线性。 */
