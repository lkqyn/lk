...
/*
 * 全工程公共硬件引脚定义。
 * PUL_CSK/PC7、PUL_DIR/PC8、PUL_EN/PC9 对应外部 STEP/DIR/EN 接口。
 */
...
#define PUL_CSK_Pin GPIO_PIN_7
#define PUL_CSK_GPIO_Port GPIOC
#define PUL_DIR_Pin GPIO_PIN_8
#define PUL_DIR_GPIO_Port GPIOC
#define PUL_EN_Pin GPIO_PIN_9
#define PUL_EN_GPIO_Port GPIOC
